...
if(!empty($_GET['search'])){
    ...
    $data = $_GET['search'];
    $sql = "SELECT * FROM fornecedores WHERE id LIKE '%$data%' or nome LIKE '%$data%' or endereco LIKE '%$data%' or contato LIKE '%$data%' ORDER BY id DESC";
...
<body>
    ...
    <div class="container">
        ...
        <div id="box-search">
            ...
            <a href="cad_forne.php" class="add-button">Cadastrar Fornecedor</a>
        </div>
    </div>

    <div class="m-5">
        <table>
        <h1><font color=#FFFF00>Lista de Fornecedores</h1></font>
            <thead>
                <th scope="col">ID</th>
            ...
            <tbody>
                ...
                while ($user_data = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>
                    <a class='btn edit' href='painel_edit_forne.php?codigo={$user_data['id']}'>
...
<script>
    ...
    function searchData(){
        window.location = 'show_forne.php?search='+search.value;
    }    
</script>
